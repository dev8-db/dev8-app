...
export default function Articles({ slice, des }) {
    const articles = [
        ...
        { title: 'Gatsby.js 入門', description: "Gatsbyとは https://www.gatsbyjs.com/docs/ Gatsby is a React-based open source framework for creating websites. Whether your site has 100 pages or 100,000 pages — if you care deeply about performance, scalability, and built-in security — you'll love building with us. Start pulling data from your ...", url: 'https://zenn.dev/dev8/articles/gatsby_tutorial' }
    ];
